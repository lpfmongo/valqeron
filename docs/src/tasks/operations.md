...
| **A future row comes due** | No polling: the dispatcher sleeps until the queue's earliest `scheduled_at` (watermark), capped at 600s | `future_row_dispatches_via_the_watermark_not_the_fallback` |
